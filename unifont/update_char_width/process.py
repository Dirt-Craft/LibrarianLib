...
widths = [width-1 if width % 2 == 1 else width for width in widths] # 1 unifont pixel = 0.5 mc pixels. MC rounds down. Thus, subtract 1 if mc 
...
with open("unifont-" + unifont_version + "-respanned.sfd", "w") as output_file:
    with open("unifont-" + unifont_version + ".sfd", "r") as input_file:
        for line in input_file:
            ...
            if width_index >= 0 and width_index < len(widths):
