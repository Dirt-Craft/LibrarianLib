...
open class SlotType {
     ...
     */
    open fun onPickup(slot: SlotBase, player: EntityPlayer?, stack: ItemStack) = true

    /**
     * Called in the slot `onSlotChange()` method, return false to cancel default handling.
     */
    open fun onSlotChange(slot: SlotBase) = true

    /**
     * Called in the slot `onSlotChange(old, new)` method, return false to cancel default handling.
     */
    open fun onSlotChange(slot: SlotBase, old: ItemStack, new: ItemStack) = true
