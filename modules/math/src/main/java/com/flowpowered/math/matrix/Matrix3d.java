...
public class Matrix3d implements Matrixd, Serializable, Cloneable {
    ...
    public Matrix3d(@NotNull Matrix2d m) {
        this(
    ...
    public Matrix3d(@NotNull Matrix3d m) {
        this(
                m.m00, m.m01, m.m02,
                m.m10, m.m11, m.m12,
                m.m20, m.m21, m.m22);
    ...
    public Matrix3d(@NotNull Matrix4d m) {
        this(
    ...
    public Matrix3d(@NotNull MatrixNd m) {
        m00 = m.get(0, 0);
        m01 = m.get(0, 1);
        m10 = m.get(1, 0);
        m11 = m.get(1, 1);
        ...
        AllocationTracker.instancesMatrix3d++;
    }
    ...
    public Vec3d getRow(int row) {
        return new Vec3d(get(row, 0), get(row, 1), get(row, 2));
    }

    @NotNull
    @Override
    public Vec3d getColumn(int col) {
        return new Vec3d(get(0, col), get(1, col), get(2, col));
    }

    @NotNull
    public Matrix3d add(@NotNull Matrix3d m) {
        return new Matrix3d(
    ...
    @NotNull
    public Matrix3d plus(@NotNull Matrix3d m) {
        return add(m);
    }

    @NotNull
    public Matrix3d sub(@NotNull Matrix3d m) {
        return new Matrix3d(
                m00 - m.m00, m01 - m.m01, m02 - m.m02,
                m10 - m.m10, m11 - m.m11, m12 - m.m12,
                m20 - m.m20, m21 - m.m21, m22 - m.m22);
    ...
    /** Operator function for Kotlin */
    @NotNull
    public Matrix3d minus(@NotNull Matrix3d m) {
        return sub(m);
    }
    ...
    @NotNull
    public Matrix3d mul(@NotNull Matrix3d m) {
        return new Matrix3d(
    ...
    /** Operator function for Kotlin */
    @NotNull
    public Matrix3d times(@NotNull Matrix3d m) {
        return mul(m);
    }
    ...
    @NotNull
    public Matrix3d div(@NotNull Matrix3d m) {
        return mul(m.invert());
    }
    ...
    @NotNull
    public Matrix3d translate(@NotNull Vec2d v) {
    ...
    @NotNull
    public Matrix3d scale(@NotNull Vec3d v) {
    ...
    @NotNull
    public Matrix3d rotate(@NotNull Complexd rot) {
        return createRotation(rot).mul(this);
    }

    @NotNull
    public Matrix3d rotate(@NotNull Quaterniond rot) {
        return createRotation(rot).mul(this);
    }

    @NotNull
    public Vec3d transform(@NotNull Vec3d v) {
    ...
    @NotNull
    public Vec3d transform(float x, float y, float z) {
    ...
    public static Matrix3d createScaling(@NotNull Vec3d v) {
    ...
    public static Matrix3d createTranslation(@NotNull Vec2d v) {
    ...
    public static Matrix3d createRotation(@NotNull Complexd rot) {
        rot = rot.normalize();
        return new Matrix3d(
                rot.getX(), -rot.getY(), 0,
                rot.getY(), rot.getX(), 0,
    ...
    public static Matrix3d createRotation(@NotNull Quaterniond rot) {
        rot = rot.normalize();
        return new Matrix3d(
