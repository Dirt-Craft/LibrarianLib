...
public class Quaternionf implements Imaginaryf, Comparable<Quaternionf>, Serializable, Cloneable {
    ...
    public Quaternionf(float x, float y, float z, float w) {
        ...
        this.z = z;
        this.w = w;
        AllocationTracker.instancesQuaternionf++;
    }
     ...
     */
    public Quaternionf(@NotNull Quaternionf q) {
     ...
     */
    @NotNull
    public Quaternionf add(@NotNull Quaternionf q) {
        return add(q.x, q.y, q.z, q.w);
    }
    /** Operator function for Kotlin */
    @NotNull
    public Quaternionf plus(@NotNull Quaternionf q) {
        return add(q);
    }
     ...
     */
    @NotNull
    public Quaternionf sub(@NotNull Quaternionf q) {
        return sub(q.x, q.y, q.z, q.w);
    }
    /** Operator function for Kotlin */
    @NotNull
    public Quaternionf minus(@NotNull Quaternionf q) {
        return sub(q);
    }
    ...
    /** Operator function for Kotlin */
    @NotNull
    public Quaternionf times(double a) {
        return mul(a);
    }
    ...
    /** Operator function for Kotlin */
    @NotNull
    public Quaternionf times(float a) {
        return mul(a);
    }
     ...
     */
    @NotNull
    public Quaternionf mul(@NotNull Quaternionf q) {
        return mul(q.x, q.y, q.z, q.w);
    }
    /** Operator function for Kotlin */
    @NotNull
    public Quaternionf times(@NotNull Quaternionf q) {
        return add(q);
    }
     ...
     */
    @NotNull
    public Quaternionf div(@NotNull Quaternionf q) {
     ...
     */
    public float dot(@NotNull Quaternionf q) {
     ...
     */
    @NotNull
    public Vec3f rotate(@NotNull Vec3f v) {
     ...
     */
    @NotNull
    public Vec3f rotate(float x, float y, float z) {
    ...
    /**
     * Returns a unit vector representing the direction of this quaternion, which is {@link Vec3f#FORWARD} rotated by this quaternion.
     *
     * @return The vector representing the direction this quaternion is pointing to
     */
    @NotNull
    public Vec3f getDirection() {
        return rotate(Vec3f.FORWARD);
    }
   ...
   @Override
    ...
    @Override
    public int compareTo(@NotNull Quaternionf q) {
    ...
    public static Quaternionf fromAxesAnglesDeg(float pitch, float yaw, float roll) {
        return Quaternionf.fromAngleDegAxis(yaw, Vec3f.UNIT_Y).
                mul(Quaternionf.fromAngleDegAxis(pitch, Vec3f.UNIT_X)).
                mul(Quaternionf.fromAngleDegAxis(roll, Vec3f.UNIT_Z));
    }
    ...
    public static Quaternionf fromAxesAnglesRad(float pitch, float yaw, float roll) {
        return Quaternionf.fromAngleRadAxis(yaw, Vec3f.UNIT_Y).
                mul(Quaternionf.fromAngleRadAxis(pitch, Vec3f.UNIT_X)).
                mul(Quaternionf.fromAngleRadAxis(roll, Vec3f.UNIT_Z));
    }
     ...
     */
    public static Quaternionf fromRotationTo(@NotNull Vec3f from, @NotNull Vec3f to) {
     ...
     */
    public static Quaternionf fromAngleDegAxis(double angle, @NotNull Vec3f axis) {
     ...
     * @return The quaternion defined by the rotation around the axis
     */
    public static Quaternionf fromAngleRadAxis(double angle, @NotNull Vec3f axis) {
     ...
     * @return The quaternion defined by the rotation around the axis
     */
    public static Quaternionf fromAngleDegAxis(float angle, @NotNull Vec3f axis) {
     ...
     * @return The quaternion defined by the rotation around the axis
     */
    public static Quaternionf fromAngleRadAxis(float angle, @NotNull Vec3f axis) {
     ...
     */
    public static Quaternionf fromRotationMatrix(@NotNull Matrix3f matrix) {
