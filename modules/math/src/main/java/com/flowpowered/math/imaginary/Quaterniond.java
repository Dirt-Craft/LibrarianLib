...
public class Quaterniond implements Imaginaryd, Comparable<Quaterniond>, Serializable, Cloneable {
    ...
    public Quaterniond(double x, double y, double z, double w) {
        ...
        this.z = z;
        this.w = w;
        AllocationTracker.instancesQuaterniond++;
    }
     ...
     */
    public Quaterniond(@NotNull Quaterniond q) {
     ...
     */
    @NotNull
    public Quaterniond add(@NotNull Quaterniond q) {
        return add(q.x, q.y, q.z, q.w);
    }
    /** Operator function for Kotlin */
    @NotNull
    public Quaterniond plus(@NotNull Quaterniond q) {
        return add(q);
    }
     ...
     */
    @NotNull
    public Quaterniond sub(@NotNull Quaterniond q) {
        return sub(q.x, q.y, q.z, q.w);
    }
    /** Operator function for Kotlin */
    @NotNull
    public Quaterniond minus(@NotNull Quaterniond q) {
        return sub(q);
    }
    ...
    /** Operator function for Kotlin */
    @NotNull
    public Quaterniond times(float a) {
        return mul(a);
    }
    ...
    /** Operator function for Kotlin */
    @NotNull
    public Quaterniond times(double a) {
        return mul(a);
    }
     ...
     */
    @NotNull
    public Quaterniond mul(@NotNull Quaterniond q) {
        return mul(q.x, q.y, q.z, q.w);
    }
    /** Operator function for Kotlin */
    @NotNull
    public Quaterniond times(@NotNull Quaterniond q) {
        return add(q);
    }
     ...
     */
    @NotNull
    public Quaterniond div(@NotNull Quaterniond q) {
     ...
     */
    public double dot(@NotNull Quaterniond q) {
     ...
     */
    @NotNull
    public Vec3d rotate(@NotNull Vec3d v) {
     ...
     */
    @NotNull
    public Vec3d rotate(float x, float y, float z) {
    ...
    /**
     * Returns a unit vector representing the direction of this quaternion, which is {@link Vec3d#FORWARD} rotated by this quaternion.
     *
     * @return The vector representing the direction this quaternion is pointing to
     */
    @NotNull
    public Vec3d getDirection() {
        return rotate(Vec3d.FORWARD);
    }
   ...
   @Override
    ...
    @Override
    public int compareTo(@NotNull Quaterniond q) {
    ...
    public static Quaterniond fromAxesAnglesDeg(double pitch, double yaw, double roll) {
        return Quaterniond.fromAngleDegAxis(yaw, Vec3d.UNIT_Y).
                mul(Quaterniond.fromAngleDegAxis(pitch, Vec3d.UNIT_X)).
                mul(Quaterniond.fromAngleDegAxis(roll, Vec3d.UNIT_Z));
    }
    ...
    public static Quaterniond fromAxesAnglesRad(double pitch, double yaw, double roll) {
        return Quaterniond.fromAngleRadAxis(yaw, Vec3d.UNIT_Y).
                mul(Quaterniond.fromAngleRadAxis(pitch, Vec3d.UNIT_X)).
                mul(Quaterniond.fromAngleRadAxis(roll, Vec3d.UNIT_Z));
    }
     ...
     */
    public static Quaterniond fromRotationTo(@NotNull Vec3d from, @NotNull Vec3d to) {
     ...
     */
    public static Quaterniond fromAngleDegAxis(float angle, @NotNull Vec3d axis) {
     ...
     * @return The quaternion defined by the rotation around the axis
     */
    public static Quaterniond fromAngleRadAxis(float angle, @NotNull Vec3d axis) {
     ...
     * @return The quaternion defined by the rotation around the axis
     */
    public static Quaterniond fromAngleDegAxis(double angle, @NotNull Vec3d axis) {
     ...
     * @return The quaternion defined by the rotation around the axis
     */
    public static Quaterniond fromAngleRadAxis(double angle, @NotNull Vec3d axis) {
     ...
     */
    public static Quaterniond fromRotationMatrix(@NotNull Matrix3d matrix) {
