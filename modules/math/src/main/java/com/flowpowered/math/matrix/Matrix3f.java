...
public class Matrix3f implements Matrixf, Serializable, Cloneable {
    ...
    public Matrix3f(@NotNull Matrix2f m) {
        this(
    ...
    public Matrix3f(@NotNull Matrix3f m) {
        this(
                m.m00, m.m01, m.m02,
                m.m10, m.m11, m.m12,
                m.m20, m.m21, m.m22);
    ...
    public Matrix3f(@NotNull Matrix4f m) {
        this(
    ...
    public Matrix3f(@NotNull MatrixNf m) {
        m00 = m.get(0, 0);
        m01 = m.get(0, 1);
        m10 = m.get(1, 0);
        m11 = m.get(1, 1);
        ...
        AllocationTracker.instancesMatrix3f++;
    }
    ...
    public Vec3f getRow(int row) {
        return new Vec3f(get(row, 0), get(row, 1), get(row, 2));
    }

    @NotNull
    @Override
    public Vec3f getColumn(int col) {
        return new Vec3f(get(0, col), get(1, col), get(2, col));
    }

    @NotNull
    public Matrix3f add(@NotNull Matrix3f m) {
        return new Matrix3f(
    ...
    @NotNull
    public Matrix3f plus(@NotNull Matrix3f m) {
        return add(m);
    }

    @NotNull
    public Matrix3f sub(@NotNull Matrix3f m) {
        return new Matrix3f(
                m00 - m.m00, m01 - m.m01, m02 - m.m02,
                m10 - m.m10, m11 - m.m11, m12 - m.m12,
                m20 - m.m20, m21 - m.m21, m22 - m.m22);
    ...
    /** Operator function for Kotlin */
    @NotNull
    public Matrix3f minus(@NotNull Matrix3f m) {
        return sub(m);
    }
    ...
    /** Operator function for Kotlin */
    @NotNull
    public Matrix3f times(double a) {
        return mul(a);
    }
    ...
    @NotNull
    @Override
    public Matrix3f times(float a) {
        return mul(a);
    }

    @NotNull
    public Matrix3f mul(@NotNull Matrix3f m) {
        return new Matrix3f(
    ...
    /** Operator function for Kotlin */
    @NotNull
    public Matrix3f times(@NotNull Matrix3f m) {
        return mul(m);
    }
    ...
    @NotNull
    public Matrix3f div(@NotNull Matrix3f m) {
        return mul(m.invert());
    }
    ...
    @NotNull
    public Matrix3f translate(@NotNull Vec2f v) {
    ...
    @NotNull
    public Matrix3f scale(@NotNull Vec3f v) {
    ...
    @NotNull
    public Matrix3f rotate(@NotNull Complexf rot) {
        return createRotation(rot).mul(this);
    }

    @NotNull
    public Matrix3f rotate(@NotNull Quaternionf rot) {
        return createRotation(rot).mul(this);
    }

    @NotNull
    public Vec3f transform(@NotNull Vec3f v) {
    ...
    public static Matrix3f createScaling(@NotNull Vec3f v) {
    ...
    public static Matrix3f createTranslation(@NotNull Vec2f v) {
    ...
    public static Matrix3f createRotation(@NotNull Complexf rot) {
        rot = rot.normalize();
        return new Matrix3f(
                rot.getX(), -rot.getY(), 0,
                rot.getY(), rot.getX(), 0,
    ...
    public static Matrix3f createRotation(@NotNull Quaternionf rot) {
        rot = rot.normalize();
        return new Matrix3f(
