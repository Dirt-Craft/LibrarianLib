...
public class Complexf implements Imaginaryf, Comparable<Complexf>, Serializable, Cloneable {
    ...
    public Complexf(float x, float y) {
        this.x = x;
        this.y = y;
        AllocationTracker.instancesComplexf++;
    }
     ...
     */
    public Complexf(@NotNull Complexf c) {
        this.x = c.x;
        this.y = c.y;
        AllocationTracker.instancesComplexf++;
    }
     ...
     */
    @NotNull
    public Complexf add(@NotNull Complexf c) {
        return add(c.x, c.y);
    }
    /** Operator function for Kotlin */
    @NotNull
    public Complexf plus(@NotNull Complexf c) {
        return add(c);
    }
     ...
     */
    @NotNull
    public Complexf sub(@NotNull Complexf c) {
        return sub(c.x, c.y);
    }
    /** Operator function for Kotlin */
    @NotNull
    public Complexf minus(@NotNull Complexf c) {
        return sub(c);
    }
    ...
    /** Operator function for Kotlin */
    @NotNull
    public Complexf times(double a) {
        return mul(a);
    }
     ...
     */
    @NotNull
    public Complexf mul(@NotNull Complexf c) {
        return mul(c.x, c.y);
    }
    /** Operator function for Kotlin */
    @NotNull
    public Complexf times(@NotNull Complexf c) {
        return mul(c);
    }
     ...
     */
    @NotNull
    public Complexf div(@NotNull Complexf c) {
        return div(c.x, c.y);
    }
     ...
     */
    public float dot(@NotNull Complexf c) {
        return dot(c.x, c.y);
    }
     ...
     */
    @NotNull
    public Vec2f rotate(@NotNull Vec2f v) {
     ...
     */
    @NotNull
    public Vec2f rotate(double x, double y) {
     ...
     */
    @NotNull
    public Vec2f rotate(float x, float y) {
        ...
        return new Vec2f(x * nx - y * ny, y * nx + x * ny);
    }
    ...
    public Vec2f getDirection() {
        return new Vec2f(x, y).normalize();
    }
    ...
    public Quaternionf toQuaternion() {
        return toQuaternion(Vec3f.UNIT_Z);
    }
     ...
     */
    @NotNull
    public Quaternionf toQuaternion(@NotNull Vec3f axis) {
    ...
    @Override
    public int compareTo(@NotNull Complexf c) {
     ...
     */
    public static Complexf fromRotationTo(@NotNull Vec2f from, @NotNull Vec2f to) {
     ...
     * @return The complex defined by the angle between the vectors
     */
    public static Complexf fromRotationTo(@NotNull Vec3f from, @NotNull Vec3f to) {
        return fromAngleRad(TrigMath.acos(from.dot(to) / (from.length() * to.length())));
    }
