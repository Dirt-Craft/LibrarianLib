...
public class Complexd implements Imaginaryd, Comparable<Complexd>, Serializable, Cloneable {
    ...
    public Complexd(double x, double y) {
        this.x = x;
        this.y = y;
        AllocationTracker.instancesComplexd++;
    }
     ...
     */
    public Complexd(@NotNull Complexd c) {
        this.x = c.x;
        this.y = c.y;
        AllocationTracker.instancesComplexd++;
    }
     ...
     */
    @NotNull
    public Complexd add(@NotNull Complexd c) {
        return add(c.x, c.y);
    }
    /** Operator function for Kotlin */
    @NotNull
    public Complexd plus(@NotNull Complexd c) {
        return add(c);
    }
     ...
     */
    @NotNull
    public Complexd sub(@NotNull Complexd c) {
        return sub(c.x, c.y);
    }
    /** Operator function for Kotlin */
    @NotNull
    public Complexd minus(@NotNull Complexd c) {
        return sub(c);
    }
    ...
    /** Operator function for Kotlin */
    @NotNull
    public Complexd times(double a) {
        return mul(a);
    }
     ...
     */
    @NotNull
    public Complexd mul(@NotNull Complexd c) {
        return mul(c.x, c.y);
    }
    /** Operator function for Kotlin */
    @NotNull
    public Complexd times(@NotNull Complexd c) {
        return mul(c);
    }
     ...
     */
    @NotNull
    public Complexd div(@NotNull Complexd c) {
        return div(c.x, c.y);
    }
     ...
     */
    public double dot(@NotNull Complexd c) {
        return dot(c.x, c.y);
    }
     ...
     */
    @NotNull
    public Vec2d rotate(@NotNull Vec2d v) {
     ...
     */
    @NotNull
    public Vec2d rotate(float x, float y) {
     ...
     */
    @NotNull
    public Vec2d rotate(double x, double y) {
        ...
        return new Vec2d(x * nx - y * ny, y * nx + x * ny);
    }
    ...
    public Quaterniond toQuaternion() {
        return toQuaternion(Vec3d.UNIT_Z);
    }
     ...
     */
    @NotNull
    public Quaterniond toQuaternion(@NotNull Vec3d axis) {
    ...
    @Override
    public int compareTo(@NotNull Complexd c) {
     ...
     */
    public static Complexd fromRotationTo(@NotNull Vec2d from, @NotNull Vec2d to) {
     ...
     * @return The complex defined by the angle between the vectors
     */
    public static Complexd fromRotationTo(@NotNull Vec3d from, @NotNull Vec3d to) {
        return fromAngleRad(TrigMath.acos(from.dot(to) / (from.length() * to.length())));
    }
