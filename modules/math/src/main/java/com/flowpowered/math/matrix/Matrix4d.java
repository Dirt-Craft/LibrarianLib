...
public class Matrix4d implements Matrixd, Serializable, Cloneable {
    ...
    public Matrix4d(@NotNull Matrix2d m) {
        this(
    ...
    public Matrix4d(@NotNull Matrix3d m) {
        this(
    ...
    public Matrix4d(@NotNull Matrix4d m) {
        this(
    ...
    public Matrix4d(@NotNull MatrixNd m) {
        m00 = m.get(0, 0);
        m01 = m.get(0, 1);
        m10 = m.get(1, 0);
        m11 = m.get(1, 1);
        ...
        AllocationTracker.instancesMatrix4d++;
    }
    ...
    @NotNull
    @Override
    public Vec4d getRow(int row) {
        return new Vec4d(get(row, 0), get(row, 1), get(row, 2), get(row, 3));
    }

    @NotNull
    @Override
    public Vec4d getColumn(int col) {
        return new Vec4d(get(0, col), get(1, col), get(2, col), get(3, col));
    }

    @NotNull
    public Matrix4d add(@NotNull Matrix4d m) {
        return new Matrix4d(
    ...
    @NotNull
    public Matrix4d plus(@NotNull Matrix4d m) {
        return add(m);
    }

    @NotNull
    public Matrix4d sub(@NotNull Matrix4d m) {
        return new Matrix4d(
                m00 - m.m00, m01 - m.m01, m02 - m.m02, m03 - m.m03,
                m10 - m.m10, m11 - m.m11, m12 - m.m12, m13 - m.m13,
                m20 - m.m20, m21 - m.m21, m22 - m.m22, m23 - m.m23,
    ...
    /** Operator function for Kotlin */
    @NotNull
    public Matrix4d minus(@NotNull Matrix4d m) {
        return sub(m);
    }
    ...
    @NotNull
    @Override
    public Matrix4d times(double a) {
        return mul(a);
    }

    @NotNull
    public Matrix4d mul(@NotNull Matrix4d m) {
        return new Matrix4d(
    ...
    /** Operator function for Kotlin */
    @NotNull
    public Matrix4d times(@NotNull Matrix4d m) {
        return mul(m);
    }
    ...
    @NotNull
    public Matrix4d div(@NotNull Matrix4d m) {
        return mul(m.invert());
    }
    ...
    @NotNull
    public Matrix4d translate(@NotNull Vec3d v) {
    ...
    @NotNull
    public Matrix4d scale(@NotNull Vec4d v) {
    ...
    @NotNull
    public Matrix4d rotate(@NotNull Complexd rot) {
        return createRotation(rot).mul(this);
    }

    @NotNull
    public Matrix4d rotate(@NotNull Quaterniond rot) {
        return createRotation(rot).mul(this);
    }

    @NotNull
    public Vec4d transform(@NotNull Vec4d v) {
        return transform(v.getX(), v.getY(), v.getZ(), v.getW());
    }

    @NotNull
    public Vec4d transform(float x, float y, float z, float w) {
        return transform((double) x, (double) y, (double) z, (double) w);
    }

    @NotNull
    public Vec4d transform(double x, double y, double z, double w) {
        return new Vec4d(
    ...
    public static Matrix4d from(double n) {
         return n == 0 ? ZERO : new Matrix4d(n, n, n, n, n, n, n, n, n, n, n, n, n, n, n, n);
    }

    @NotNull
    public static Matrix4d from(double m00, double m01, double m02, double m03,
                                double m10, double m11, double m12, double m13,
                                double m20, double m21, double m22, double m23,
                                double m30, double m31, double m32, double m33) {
         ...
         ? ZERO : new Matrix4d(m00, m01, m02, m03,
                                 m10, m11, m12, m13,
                                 m20, m21, m22, m23,
                                 m30, m31, m32, m33);
    }
    ...
    public static Matrix4d fromDiagonal(double m00, double m11, double m22, double m33) {
         return m00 == 0 && m11 == 0 && m22 == 0 && m33 == 0 ? ZERO : new Matrix4d(m00, 0, 0, 0,
                                                                                     0, m11, 0, 0,
                                                                                     0, 0, m22, 0,
                                                                                     0, 0, 0, m33);
    }
    ...
    public static Matrix4d createScaling(@NotNull Vec4d v) {
    ...
    public static Matrix4d createTranslation(@NotNull Vec3d v) {
    ...
    public static Matrix4d createRotation(@NotNull Complexd rot) {
        rot = rot.normalize();
        return new Matrix4d(
    ...
    public static Matrix4d createRotation(@NotNull Quaterniond rot) {
        rot = rot.normalize();
        return new Matrix4d(
     ...
     */
    @NotNull
    public static Matrix4d createLookAt(@NotNull Vec3d eye, @NotNull Vec3d at, @NotNull Vec3d up) {
        final Vec3d f = at.sub(eye).normalize();
        final Vec3d s = f.cross(up).normalize();
        final Vec3d u = s.cross(f);
