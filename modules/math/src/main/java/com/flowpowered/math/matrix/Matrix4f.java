...
import com.flowpowered.math.vector.Vec4f;
...
public class Matrix4f implements Matrixf, Serializable, Cloneable {
    ...
    public Matrix4f(@NotNull Matrix2f m) {
        this(
    ...
    public Matrix4f(@NotNull Matrix3f m) {
        this(
    ...
    public Matrix4f(@NotNull Matrix4f m) {
        this(
    ...
    public Matrix4f(@NotNull MatrixNf m) {
        m00 = m.get(0, 0);
        m01 = m.get(0, 1);
        m10 = m.get(1, 0);
        m11 = m.get(1, 1);
        ...
        AllocationTracker.instancesMatrix4f++;
    }
    ...
    public Vec4f getRow(int row) {
        return new Vec4f(get(row, 0), get(row, 1), get(row, 2), get(row, 3));
    }

    @NotNull
    @Override
    public Vec4f getColumn(int col) {
        return new Vec4f(get(0, col), get(1, col), get(2, col), get(3, col));
    }

    @NotNull
    public Matrix4f add(@NotNull Matrix4f m) {
        return new Matrix4f(
    ...
    @NotNull
    public Matrix4f plus(@NotNull Matrix4f m) {
        return add(m);
    }

    @NotNull
    public Matrix4f sub(@NotNull Matrix4f m) {
        return new Matrix4f(
                m00 - m.m00, m01 - m.m01, m02 - m.m02, m03 - m.m03,
                m10 - m.m10, m11 - m.m11, m12 - m.m12, m13 - m.m13,
                m20 - m.m20, m21 - m.m21, m22 - m.m22, m23 - m.m23,
    ...
    /** Operator function for Kotlin */
    @NotNull
    public Matrix4f minus(@NotNull Matrix4f m) {
        return sub(m);
    }
    ...
    /** Operator function for Kotlin */
    @NotNull
    public Matrix4f times(double a) {
        return mul(a);
    }
    ...
    @NotNull
    @Override
    public Matrix4f times(float a) {
        return mul(a);
    }

    @NotNull
    public Matrix4f mul(@NotNull Matrix4f m) {
        return new Matrix4f(
    ...
    /** Operator function for Kotlin */
    @NotNull
    public Matrix4f times(@NotNull Matrix4f m) {
        return mul(m);
    }
    ...
    @NotNull
    public Matrix4f div(@NotNull Matrix4f m) {
        return mul(m.invert());
    }
    ...
    @NotNull
    public Matrix4f translate(@NotNull Vec3f v) {
    ...
    @NotNull
    public Matrix4f scale(@NotNull Vec4f v) {
    ...
    @NotNull
    public Matrix4f rotate(@NotNull Complexf rot) {
        return createRotation(rot).mul(this);
    }

    @NotNull
    public Matrix4f rotate(@NotNull Quaternionf rot) {
        return createRotation(rot).mul(this);
    }

    @NotNull
    public Vec4f transform(@NotNull Vec4f v) {
        return transform(v.getX(), v.getY(), v.getZ(), v.getW());
    }

    @NotNull
    public Vec4f transform(double x, double y, double z, double w) {
        return transform((float) x, (float) y, (float) z, (float) w);
    }

    @NotNull
    public Vec4f transform(float x, float y, float z, float w) {
        return new Vec4f(
    ...
    public static Matrix4f createScaling(@NotNull Vec4f v) {
    ...
    public static Matrix4f createTranslation(@NotNull Vec3f v) {
    ...
    public static Matrix4f createRotation(@NotNull Complexf rot) {
        rot = rot.normalize();
        return new Matrix4f(
    ...
    public static Matrix4f createRotation(@NotNull Quaternionf rot) {
        rot = rot.normalize();
        return new Matrix4f(
     ...
     */
    @NotNull
    public static Matrix4f createLookAt(@NotNull Vec3f eye, @NotNull Vec3f at, @NotNull Vec3f up) {
        final Vec3f f = at.sub(eye).normalize();
        final Vec3f s = f.cross(up).normalize();
        final Vec3f u = s.cross(f);
