...
interface CoordinateSpace2D {
     ...
     */
    @JvmDefault
    fun conversionMatrixFrom(other: CoordinateSpace2D): Matrix3 = other.conversionMatrixTo(this)
     ...
     */
    @JvmDefault
    fun convertRectFrom(rect: Rect2d, other: CoordinateSpace2D): Rect2d = other.convertRectTo(rect, this)
     ...
     */
    fun convertPointToParent(point: Vec2d): Vec2d = parentSpace?.let { convertPointTo(point, it) } ?: point
     ...
     * If this space has no parent, this method returns the original point.
     */
    fun convertPointFromParent(point: Vec2d): Vec2d = parentSpace?.let { convertPointFrom(point, it) } ?: point
     ...
     * instead it will _contain_ it.
     */
    fun convertRectToParent(rect: Rect2d): Rect2d = parentSpace?.let { convertRectTo(rect, it) } ?: rect
     ...
     * rect, instead it will _contain_ it.
     */
    fun convertRectFromParent(rect: Rect2d): Rect2d = parentSpace?.let { convertRectFrom(rect, it) } ?: rect
